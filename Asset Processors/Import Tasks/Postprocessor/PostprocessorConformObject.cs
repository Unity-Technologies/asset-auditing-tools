...
{
	public class PostprocessorConformObject : IConformObject
	{
		...
		public PostprocessorConformObject( string name, int methodVersion )
		{
		...
		public PostprocessorConformObject( string name, int methodVersion, int importedVersion )
		{
			// method name and importedVersion for the method in question. (may need to get it when checking conforms instead)
			m_MethodName = name;
			m_MethodVersion = methodVersion;
